...
| TC06 | Veatuvastus: olematu ID-ga broneeringu kustutamine | Veaolukord | 1. Vali menüüst: "Delete booking"<br>2. Sisesta ID, mida andmebaasis kindlasti ei ole (nt 99999) | Pythoni skript kontrollib enne kustutamist ID olemasolu või tuvastab, et andmebaasis muudeti 0 rida. Kuvatakse teade: "Viga: sellise ID-ga broneeringut ei eksisteeri!". | PASSED | Programm ei krahhi, vigast kustutamist ei toimu. |
